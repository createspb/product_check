export default {
  ...
  subresults: {
    "4": {
      "1": [
        'У вас очень неловкая ситуация. Вы собираетесь делать продукт, но не определились какой, для кого и для чего.',
        'Вы рискуете затянуть создание продукта, превысить рамки бюджета, а в конце представить людям продукт, который им не нужен.',
        'Настоятельно рекомендуем сосредоточиться на формулировании базового понимания своего продукта, чтобы ответить “Да” на первые вопросы перед продолжением теста.'
      ],
      "2": [
        'Судя по всему вы, приладили к стулу две ноги, но не зафиксировали третью — это делает его довольно неустойчивым.',
        'Вы рискуете сделать качественный продукт, решающий несуществующую проблему; решать настоящую проблему там, где ее нет или предложить к существующей проблеме реальных людей не подходящее решение.',
        'Можно продолжать, но мы рекомендуем осредоточиться на формулировании понимания своего продукта, чтобы ответить “Да” на первые вопросы.'
      ],
      "3": [
        'Выглядит неплохо! Вы понимаете с какой проблемой имеете дело, знаете кому нужно предлагать решение и как оно может выглядеть. Из этого понимания будут строиться ответы на все дальнейшие вопросы вашего продукта и бизнеса.'
      ]
    },
    "7": {
      "2": [
        'Вы все еще в очень неловкой ситуцаии, вы все еще не знаете, что, зачем и для кого делаете. Что довольно логично — проверить гипотезы и сформулировать уникальный подход без понимания того, что делает продукт, довольно сложно.',
        'Настоятельно рекомендуем сосредоточиться на формулировании идеи своего продукта перед продолжением теста.'
      ],
      "4": [
        'Ваш продукт страдает от недостатка взаимопонимания с бизнесом. Несколько важнейших основ не зафиксированы. Вы рискуете сделать не то не тем, потратить время на реализацию ненужного людям продукта или попасть в условия жесткой конкуренции с существующими игроками рынка.',
        'Мы рекомендуем вам сформулировать идею и проверить гипотезы продукта перед продолжением теста.'
      ],
      "5": [
        'Неплохо, но в паре мест зияют пробелы. Каждый пробел — потенциальноая проблема, способная помешать реализации и развитию продукта. Природа проблемы будет зависеть от непроработанного места.',
        'Можно продолжать, но мы рекомендуем осредоточиться на детализации понимания своего продукта, чтобы ответить “Да” на все предыдущие вопросы.'
      ],
      "6": [
        'Отлично! Из понимания общей идеи вы успешно перешли к проверке рабочих гипотез — как на практике, так и посредством анализа чужого опыта.'
      ]
    }
  },
  "0": {
