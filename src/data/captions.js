export default {
  ...
  results: {
    ...
    articlesListTitle: 'Статьи по теме',
    articleTitle: 'Что это за таблица ',
    articleDescription: 'Блог Create Digital',
    recomendationsTitle: 'Что делать, если все плохо',
    recomendationsDescription: 'Блог Create Digital',
    from: 'от ',
    companyName: 'Create',
    companyPartner: 'D/C',
